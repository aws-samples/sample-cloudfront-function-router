...
# Send message to SQS
aws sqs send-message --queue-url $SQS_URL --message-body '{"tenant_id": "tenant_1", "cluster_id": "cluster_1"}' --no-cli-pager
aws sqs send-message --queue-url $SQS_URL --message-body '{"tenant_id": "tenant_2", "cluster_id": "cluster_2"}' --no-cli-pager
